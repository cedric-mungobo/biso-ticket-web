            ...
            <div class="absolute bottom-0 left-0 right-0 z-10 pb-2 px-4">
                <div class="text-center text-white max-w-4xl mx-auto">
                    ...
                    >
                        <!-- Titre principal -->
                        <h1
                            class="text-2xl sm:text-4xl lg:text-5xl font-serif font-bold mb-4 leading-tight drop-shadow-2xl"
                        >
                            {{
        ...
        >
            ...
            <div class="invitation-content relative z-10">
                ...
                <h2
                    ...
                    :delay="600"
                    :duration="1400"
                    class="md:text-5xl uppercase text-3xl font-serif mt-4 font-bold text-center mb-12 tracking-wide"
                ...
                >
                    <div
                        ...
                        :style="{
                            color: textColor,
                            fontSize: messageFontSize - 15 + 'px',
                        }"
                    >
                        <p
...
onMounted(async () => {
    try {
        ...
        if (eventId) {
            ...
            console.log(
                "🍷 Boissons chargées pour l'événement:",
                drinks.length,
...
const processedGuestMessage = computed(() => {
    ...
    console.log(
        "🔍 Message original (template_mariage_1):",
        guestMessage.value,
    );
...
const messageFontSize = computed(() => {
    ...
    console.log(
        "📏 Taille de police calculée (mariage):",
        fontSize,
        "pour le texte:",
...
const handleDownloadInvitation = async () => {
    try {
        ...
        console.log("📤 Message HTML envoyé au canvas:", cleanMessage);
