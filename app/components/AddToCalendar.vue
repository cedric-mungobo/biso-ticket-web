<template>
  <div class="relative w-full">
    <button
      ...
      class="w-full border border-primary-600 text-primary-600 px-6 py-3 rounded-lg hover:bg-primary-50 transition-colors font-medium flex items-center justify-center gap-2"
    >
