<template>
  <div class="relative w-full">
    <button
      ...
      class="bg-primary-600 text-white px-2 py-1.5 w-full rounded-lg hover:bg-primary-700 transition-all duration-200 font-medium flex items-center justify-center gap-2 shadow-sm hover:shadow-md"
    >
